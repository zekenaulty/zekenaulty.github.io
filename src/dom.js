export class DOM {
    ...
    static navbar(options = {}) {
      const { brandText, brandHref, items } = options;
      const navbar = DOM.element('nav', { classes: ['navbar', 'navbar-expand-lg', 'navbar-light', 'bg-light'] });
      const container = DOM.container({ parent: navbar });
      ...
      const toggleButton = DOM.element('button', {
        parent: container,
