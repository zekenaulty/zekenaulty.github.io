...
export class OffCanvas extends BaseComponent {
    ...
    buildOffCanvas() {
        ...
        // Create layout manager and scrollspy instances
        const layoutManager = new LayoutManager(body, {
            sections: this.sections.map(section => new Section(null, section)),
        });

        const scrollSpy = new ScrollSpy(body, layoutManager, {
