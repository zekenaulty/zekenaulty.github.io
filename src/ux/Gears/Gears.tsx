...
const Gears: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const gears = [
            new Gear({ x: 0, y: 0, outerRadius: 30, innerRadius: 45, holeRadius: 12, numTeeth: 12, theta: 0, thetaSpeed: 1 / 1000, clockwise: false }),
            new Gear({ x: 0, y: 90, outerRadius: 30, innerRadius: 45, holeRadius: 12, numTeeth: 12, theta: 0, thetaSpeed: 1 / 1000, clockwise: false }),
            ...
            new Gear({ x: 45, y: 45, outerRadius: 15, innerRadius: 23, holeRadius: 10, numTeeth: 12, theta: 0.1, thetaSpeed: 2 / 1000, clockwise: true }),
        ];
